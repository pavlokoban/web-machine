  ...
  return (
    <>
      ...
      <div id="content-container" className="relative z-0 container mx-auto p-10 px-10 m-10 border-36 white112 desc-padding-70-mob-30">
        ...
        <p>Непосредственное решение о создании компании WEB-MACHINE с акцентом на интернет-маркетинге было принято <b>летом 2013 года</b> Павлом Соколенко в Амстердаме. Тем не менее на рынке разработки сайтов компания начала свою работу в мае 2011 года под торговой маркой &quot;Сайт Сайтович&quot;, у истоков которой стоял также Дмитрий Бабков.<br></br>
