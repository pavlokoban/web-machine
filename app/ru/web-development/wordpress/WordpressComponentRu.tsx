...
<>
    <div className="relative w-full overflow-hidden gray112">
      ...
      <h1 className={'unbounded centered-texts'}>Создание сайтов на WordPress</h1>
      <h4 className={'centered-texts sub-title-service-texts'}>Создание сайта на CMS WordPress — это разработка на самой популярной веб-платформе в мире! От лендигов до порталов, корпоративные сайты, блоги, интернет-магазины, аукционы - все это можно реализовать вместе с Wordpress!
        </h4>
    ...
    <div className="relative z-10 container mx-auto p-10 px-10 m-10 w-100">
    <h2 className='h3ash1'>Примеры работ по созданию сайтов на CMS WordPress</h2>
    ...
    <div className={'desc-flex-mob-block'}>
      ...
      <div className="relative w-full overflow-hidden white112">
      <div className="relative z-10 container mx-auto p-10 px-10 m-10 w-100">
        <h2 className='h3ash1'>Этапы разработки сайта на Wordpress</h2>
        <p>Разрабатываем сайты на CMS Wordpress и проектируем веб-интерфейсы с 2013 года, имеем опыт и экспертизу в веб-дизайне, верстке и программировании на PHP, JS.</p>
...
export default WordpressComponentRu;