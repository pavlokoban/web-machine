...
const LayoutMainRuGreen: React.FC<LayoutMainProps> = ({ children }) => {
  return (
    <>
      <div className={'flex min-h-screen flex-col justify-between brave112'}>
        <header>
...
export default LayoutMainRuGreen;
